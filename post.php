<?php 
			...
			if (isset($_GET['post_id'])) {
				...
				$sql = "SELECT post_title,post_content,seo_title,post_description,key_word,category_id,createdate,updatedate FROM posts WHERE post_id = '$post_id' ";
