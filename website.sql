...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th2 21, 2018 lúc 06:39 PM
...
(0, 'Uncategory', 'uncategory'),
(1, 'Chuyện code', 'chuyen-code'),
(4, 'Phần mềm', 'phan-mem'),
(5, 'Công nghệ', 'cong-nghe'),
(6, 'Xàm xí chuyện PHP', 'xam-xi-chuyen-php');
...
(27, '1802181053-sasa.PNG', '/uploads/image/1802181053-sasa.PNG', 'image/png', 176161, '', 0);
...
INSERT INTO `users` (`id`, `username`, `password`, `name`, `gender`, `email`, `level`) VALUES
(1, 'admin', '123456', 'admin', NULL, 'admin@gmail.com', 1),
(16, 'nam', '123456', 'NAM DOAN QUOC', 'female', 'huyen@gmail.com', 2),
(17, 'lai', '123456', 'lai', 'male', 'lai@gmail.com', 2);
